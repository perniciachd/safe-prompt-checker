    ...
    def do_POST(self):
        ...
        try:
            ...
            if "detection_result" not in data:
                return self._send_json({"error": "Missing 'detection_result' field in request body"}, 400, request_id, started_at)
            ...
            if not isinstance(detection_result, dict):
                return self._send_json({"error": "detection_result must be an object"}, 400, request_id, started_at)
