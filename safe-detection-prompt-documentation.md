...
### 6.3 Test 3 — Compensation Analysis (PENDING)

**Status:** Not yet run
**Prompt Version To Use:** 1.2
...
**What to watch for:**
- Does the detector recognise that "new senior hire from Morgan Stanley joining at 2.4 cr fixed" is identifying even without a name?
- Are personal name + role combinations correctly classified?
- Does the combinatorial notes section address the cross-firm identification risk?
